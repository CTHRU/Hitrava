...
def parse_filename():
    ...
    for argument in sys.argv[1:]:
        if argument == '-f':
            ...
            validate = True
        elif argument[:7] == 'HiTrack':
            input_file = argument
        elif argument[:9] == '.\\HiTrack':
    ...
    return input_file, (start_time, duration), (filter, validate)
...
def save_xml(TrainingCenterDatabase, input_file):
    ...
    try:
        ...
        new_filename = 'TCX'+input_file[7:]+'.tcx'
...
input_file, stats, options = parse_filename()
data = read_file(input_file)
if options[0]: data = filter_data(data)
...
if options[1]: validate_xml(filename, xmlschema_found)
print('\n')
